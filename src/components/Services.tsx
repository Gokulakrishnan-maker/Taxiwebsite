    ...
    <section id="services" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Kovai Drop Taxi?</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Experience the difference with Kovai Drop Taxi's premium service in Coimbatore. Licensed by Tamil Nadu Transport Department, we provide safe, reliable transportation across the state with local expertise.
          </p>
        </div>
